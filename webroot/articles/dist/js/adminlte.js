/*!
 * AdminLTE v0.2.0-rc (http://osmp.com.cn)
 * Copyright 2014-2022 Martin Dong <http://osmp.com.cn>
...
(function (global, factory) {
  ...
  var CardRefresh = /*#__PURE__*/function () {
    ...
    CardRefresh._jQueryInterface = function _jQueryInterface(config) {
      ...
      var _options = $.extend({}, Default$c, $(this).data());
      if (!data) {
        data = new CardRefresh($(this), _options);
        $(this).data(DATA_KEY$e, typeof config === 'string' ? data : config);
      }
  ...
  var CardWidget = /*#__PURE__*/function () {
    ...
    CardWidget._jQueryInterface = function _jQueryInterface(config) {
      ...
      var _options = $.extend({}, Default$b, $(this).data());
      if (!data) {
  ...
  var ControlSidebar = /*#__PURE__*/function () {
    ...
    ControlSidebar._jQueryInterface = function _jQueryInterface(operation) {
      return this.each(function () {
        ...
        var _options = $.extend({}, Default$a, $(this).data());
        if (!data) {
  ...
  var Dropdown = /*#__PURE__*/function () {
    ...
    Dropdown._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        ...
        var _config = $.extend({}, Default$9, $(this).data());
        if (!data) {
  ...
  var Fullscreen = /*#__PURE__*/function () {
    function Fullscreen(_element, _options) {
      ...
      this.options = $.extend({}, Default$8, _options);
    }
    ...
    Fullscreen._jQueryInterface = function _jQueryInterface(config) {
      ...
      var _options = $.extend({}, Default$8, typeof config === 'object' ? config : data);
      var plugin = new Fullscreen($(this), _options);
      $(this).data(DATA_KEY$8, typeof config === 'object' ? config : data);
  ...
  var Layout = /*#__PURE__*/function () {
    ...
    Layout._jQueryInterface = function _jQueryInterface(config) {
      ...
      return this.each(function () {
        ...
        var _options = $.extend({}, Default$6, $(this).data());
        if (!data) {
  ...
  var SidebarSearch = /*#__PURE__*/function () {
    ...
    SidebarSearch._jQueryInterface = function _jQueryInterface(config) {
      ...
      var _options = $.extend({}, Default$4, typeof config === 'object' ? config : data);
      var plugin = new SidebarSearch($(this), _options);
      $(this).data(DATA_KEY$4, typeof config === 'object' ? config : data);
  ...
  var NavbarSearch = /*#__PURE__*/function () {
    function NavbarSearch(_element, _options) {
      ...
      this._config = $.extend({}, Default$3, _options);
    }
    ...
    NavbarSearch._jQueryInterface = function _jQueryInterface(options) {
      return this.each(function () {
        ...
        var _options = $.extend({}, Default$3, $(this).data());
        if (!data) {
  ...
  var TodoList = /*#__PURE__*/function () {
    ...
    TodoList._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        ...
        var _options = $.extend({}, Default$1, typeof config === 'object' ? config : data);
        var plugin = new TodoList($(this), _options);
        $(this).data(DATA_KEY$1, typeof config === 'object' ? config : data);
        if (config === 'init') {
          plugin[config]();
        }
      });
